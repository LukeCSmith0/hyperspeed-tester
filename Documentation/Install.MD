...
By default all of these are stored in the /home/iperf-script folder. All of the necessary packages for the Odroid board can be found in Client-Script
...
```SQL
CREATE TABLE 'engineer_mappings' (
